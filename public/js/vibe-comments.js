...
// ── v3.20.11 (King): SVG icon set - emoji glyphs ignore CSS color and
    ...
    const REACTION_SVG = {
            ...
            like: '<g transform="translate(12 12) scale(1.3) translate(-12 -12)"><circle cx="12" cy="12" r="8.4" fill="#2f7de1" stroke="none"/><g transform="translate(12 12.6) scale(0.6) translate(-12 -12)"><path fill="#ffffff" stroke="none" d="M6.6 10h3v9H6.6a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1zm4.6 9V9.6l3.2-6.4a1.6 1.6 0 0 1 3 .9v3.6h3.9a2.1 2.1 0 0 1 2.1 2.4l-1 5.6a2.1 2.1 0 0 1-2.1 1.7H11z"/></g></g>',
